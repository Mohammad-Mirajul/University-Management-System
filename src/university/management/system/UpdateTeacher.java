...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    UpdateTeacher() {
        ...
        JLabel lblnid_number = new JLabel("NID Number");
        lblnid_number.setBounds(400, 350, 200, 30);
        lblnid_number.setFont(new Font("serif", Font.BOLD, 20));
        add(lblnid_number);
        
        JLabel labelnid_number = new JLabel();
        labelnid_number.setBounds(600, 350, 150, 30);
        labelnid_number.setFont(new Font("Tahoma", Font.PLAIN, 18));
        add(labelnid_number);
        ...
        try {
            ...
            while(rs.next()) {
                ...
                labelnid_number.setText(rs.getString("nid_number"));
