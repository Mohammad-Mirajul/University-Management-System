...
public class UpdateStudent extends JFrame implements ActionListener {
    ...
    JTextField tffaculty, tfaddress, tfphone, tfemail, tfdepartment;
    JLabel labelrollno;
    ...
    UpdateStudent() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                labelnid.setText(rs.getString("nid_number"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            Conn c = new Conn();
            String query = "update student set address='"+address+"', phone='"+phone+"', email='"+email+"', faculty='"+faculty+"', department='"+department+"' where rollno='"+rollno+"'";
